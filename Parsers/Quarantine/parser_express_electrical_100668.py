...
def detect_express_electrical_100668(text: str) -> bool:
    if not text:
        return False
    t = text.lower()
    return "express electrical and engineering supplies" in t and "po number: 100668" in t

def parse_express_electrical_100668(text: str):
