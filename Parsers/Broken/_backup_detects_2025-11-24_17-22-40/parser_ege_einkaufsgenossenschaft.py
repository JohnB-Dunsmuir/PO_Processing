# parser_ege_einkaufsgenossenschaft.py
# Repaired: 2025-11-24
...
def detect_ege_einkaufsgenossenschaft(text: str) -> bool:
    """
    Detects EGE EINKAUFSGENOSSENSCHAFT purchase orders.
    ...
    t = (text or "").upper()
    return any([
        "EGE EINKAUFSGENOSSENSCHAFT" in t,
        "@EGEEINKAUFSGENOSSENSCHAFT.COM" in t,
        "ADDRESS OR CITY FRAGMENT" in t  # replace with a known unique address/city snippet if available
    ])

def parse_ege_einkaufsgenossenschaft(text: str, source_file: str = "") -> dict:
    """
    ...
    header = {
        ...
        "Buyer": "Ege Einkaufsgennossenschaft",
        "Order Type": "Standard",
        "Delivery Address": ""
    }
