...
def detect_helu_connectivity(text: str) -> bool:
    """
    Detects HELU CONNECTIVITY purchase orders.
    ...
    t = (text or "").upper()
    return any([
        "HELU CONNECTIVITY" in t,
        "@HELUCONNECTIVITY.COM" in t,
        "ADDRESS OR CITY FRAGMENT" in t  # replace with a known unique address/city snippet if available
    ])

def parse_helu_connectivity(text: str, source_file: str = "") -> dict:
    """
